...
def get_net_path(celeb, experiment):
    ...
    path = os.path.join(training_runs_dir, celeb, experiment, '5', 'mystyle_model.pt')
...
if __name__ == '__main__':
    ...
    reconstruction_out_dir = os.path.join('/playpen-nas-ssd/awang/mystyle_original/out', args.celeb, 'reconstructions_at_5', args.experiment)
    for video in range(0, 6):
    ...
    #    generate(args.celeb, args.experiment, latent_dir, out_dir, device)
